...
let eventEmitter = {
  ...
  off: function (event, callback) {
    ...
    const len = this.list[event].length;
    for (let i = 0; i < len; i++) {
      if (this.list[event][i] === callback) {
...
eventEmitter.on("article2", user4);
// console.log(eventEmitter);
// eventEmitter.off("article1", user2);
// eventEmitter.off("article2");
// console.log(eventEmitter);
eventEmitter.emit("article1", "test111");
eventEmitter.emit("article2", "test222");